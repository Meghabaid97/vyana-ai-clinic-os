...
export const S8Rx: React.FC = () => {
  ...
  return (
    <AbsoluteFill style={{ background: COLORS.bg, opacity: op }}>
      <FloatingAccents seed={6} />
      <AbsoluteFill style={{ background: "radial-gradient(circle at 70% 30%, rgba(232,112,77,0.08) 0%, transparent 55%)" }} />
      ...
      <AbsoluteFill style={{ display: "flex", flexDirection: "row-reverse", alignItems: "center", justifyContent: "center", gap: 80, paddingRight: 40, transform: `translateX(${camX}px)` }}>
        <div style={{ flexShrink: 0 }}>
          <AppPhone delay={15} rotate={2} scale={0.9}><MockRx /></AppPhone>
        </div>
        ...
        <div style={{ maxWidth: 700 }}>
          ...
          <div style={{
            marginTop: 16, fontFamily: "Fraunces, serif", fontSize: 76, lineHeight: 1.05, color: COLORS.ink,
