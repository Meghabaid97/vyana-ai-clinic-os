        ...
        <Tabs defaultValue={defaultTab}>
          ...
          <TabsContent value="terms">
            <article className="prose prose-sm dark:prose-invert max-w-none space-y-5 text-foreground">
              ...
              <p>Welcome to {APP_NAME}, a product of {COMPANY}. By accessing or using {APP_NAME} (the "App"), you agree to be bound by these Terms of Service ("Terms"). If you do not agree to these Terms, do not use the App.</p>

              <h3 className="text-lg font-semibold">1. Nature of Service</h3>
              <p>{APP_NAME} is a <strong>clinical decision support and health record management tool</strong>. The App helps you organize health records, track vitals, manage medications, and generate shareable health summaries for your healthcare providers.</p>
              <div className="rounded-lg border border-amber-200 bg-amber-50 dark:bg-amber-950/20 dark:border-amber-800 p-4">
                <p className="text-sm font-semibold text-amber-800 dark:text-amber-200">⚠️ Important Disclaimer</p>
                <p className="text-sm text-amber-700 dark:text-amber-300 mt-1">{APP_NAME} does <strong>NOT</strong> provide medical advice, diagnosis, or treatment. All AI-generated insights, risk indicators, and health summaries are for informational purposes only. Always consult a qualified healthcare professional for medical decisions.</p>
              </div>
              ...
              <p>You agree to indemnify and hold harmless {COMPANY} from any claims, damages, losses, or expenses (including legal fees) arising from your use of the App, violation of these Terms, or infringement of any rights of another person.</p>

              <h3 className="text-lg font-semibold">9. Governing Law & Jurisdiction</h3>
              <p>These Terms are governed by the laws of <strong>India</strong>. Any disputes shall be subject to the exclusive jurisdiction of the courts in <strong>Bengaluru, Karnataka, India</strong>.</p>

              <h3 className="text-lg font-semibold">10. Changes to Terms</h3>
              <p>{COMPANY} reserves the right to modify these Terms at any time. Continued use of the App after changes constitutes acceptance of the updated Terms. We will notify you of material changes via the App or email.</p>

              <h3 className="text-lg font-semibold">11. Contact</h3>
              <p>For questions about these Terms, contact us at: <a href={`mailto:${SUPPORT_EMAIL}`} className="text-primary underline">{SUPPORT_EMAIL}</a></p>
            </article>
          </TabsContent>
          ...
          <TabsContent value="privacy">
            <article className="prose prose-sm dark:prose-invert max-w-none space-y-5 text-foreground">
              ...
              <p>This Privacy Policy describes how {COMPANY} ("{APP_NAME}", "we", "us") collects, uses, stores, and protects your personal and health information when you use the {APP_NAME} application.</p>
              ...
              <p>We do <strong>NOT</strong> sell, rent, or trade your personal or health data. Your data may be shared only in these circumstances:</p>
              <ul className="list-disc pl-5 space-y-1">
              ...
              <p>We do not knowingly collect personal data from children under 18 without verifiable parental consent. If you believe a child has provided data without consent, contact us immediately.</p>

              <h3 className="text-lg font-semibold">11. Cross-Border Data Transfer</h3>
              <p>Your data may be processed on servers located outside India. In such cases, we ensure equivalent data protection standards through contractual safeguards, in compliance with DPDPA provisions on cross-border data transfer.</p>
              ...
              <div className="rounded-lg border border-border bg-muted/30 p-4">
                <p className="text-sm"><strong>Email:</strong> <a href={`mailto:${SUPPORT_EMAIL}`} className="text-primary underline">{SUPPORT_EMAIL}</a></p>
              ...
              <p>We may update this Privacy Policy periodically. Material changes will be communicated via the App or email. Continued use after changes constitutes acceptance.</p>

              <h3 className="text-lg font-semibold">15. Governing Law</h3>
              <p>This Privacy Policy is governed by the laws of India, including the Digital Personal Data Protection Act, 2023, and the Information Technology Act, 2000.</p>
            </article>
          </TabsContent>
        </Tabs>

        <div className="mt-10 pb-10 text-center">
          <p className="text-xs text-muted-foreground">© {new Date().getFullYear()} {COMPANY}. All rights reserved.</p>
        </div>
      </div>
    </div>
  );
