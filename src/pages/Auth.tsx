        ...
        <div className="flex-1 flex flex-col justify-center min-h-min py-6">
          ...
          <div className="space-y-3">
            ...
            <button
              ...
              disabled={anyLoading}
              aria-label={isSignup ? "Sign up with Apple" : "Continue with Apple"}
              className="w-full h-12 px-4 rounded-full bg-black text-white hover:bg-black/90 disabled:opacity-60 disabled:cursor-not-allowed flex items-center justify-center gap-2.5 transition-colors"
              style={{ fontFamily: '-apple-system, BlinkMacSystemFont, "SF Pro Text", "Helvetica Neue", Helvetica, Arial, sans-serif' }}
            >
              {loadingProvider === "apple" ? (
                <Loader2 className="h-5 w-5 animate-spin" />
              ) : (
                // Official Apple logomark from Apple Design Resources (Sign in with Apple).
                <svg
                  aria-hidden="true"
                  viewBox="0 0 170 170"
