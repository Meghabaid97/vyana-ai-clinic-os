    ...
    <div className="min-h-screen bg-background">
      <nav className="sticky top-0 z-50 bg-background/95 backdrop-blur-md border-b border-border/50">
        <div className="container mx-auto px-6 py-4 flex items-center justify-between gap-4">
          <button onClick={() => navigate("/")} className="flex items-center gap-3 text-muted-foreground hover:text-foreground transition-colors">
            ...
            <span className="flex h-10 w-10 items-center justify-center rounded-2xl gradient-primary shadow-card">
      ...
      <article className="container mx-auto px-6 py-16 max-w-3xl">
        <header className="text-center mb-16 space-y-6 animate-fade-in-slow">
          <div className="inline-flex items-center gap-2 bg-primary/10 text-primary px-4 py-2 rounded-full text-sm font-medium shadow-card">
            <Heart className="h-4 w-4 fill-current" />
            The story behind Vyana
          </div>
          <h1 className="text-4xl lg:text-6xl font-bold leading-[1.1] tracking-tight">
            Why this <span className="text-gradient-warm">matters</span>
          </h1>
        </header>
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <div className="my-16 py-12 px-8 rounded-2xl bg-primary/5 border border-primary/15 shadow-soft animate-fade-in-slow" style={{ animationDelay: "0.8s" }}>
            <div className="flex items-start gap-4">
              <Heart className="h-8 w-8 text-primary mt-1 flex-shrink-0 fill-current" />
