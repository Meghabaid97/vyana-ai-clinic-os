...
const landingTranslations: Record<Language, Record<string, string>> = {
  en: {
    ...
    "research.megha.role": "Founder & CEO",
    "research.megha.bio": "Megha is pursuing her MBA at The Wharton School, where she focuses on AI, healthcare innovation, and entrepreneurship. She holds a degree in Computer Science with a specialization in ML and AI, and previously spent 4+ years at Amazon building large-scale products across commerce and infrastructure, helping 50,000+ small businesses digitize their operations.\n\nIn 2020, she led a team that won 2nd place at the Motwani Jadeja Foundation COVID innovation hackathon for building an AI-powered remote health assessment platform designed to reduce hospital bed shortages during the pandemic.",
