...
export const getEcoMessage = (
  ...
  const treesContribution = (paperSaved / 8000).toFixed(3); // ~8000 sheets = 1 tree
  ...
  return `🌿 ${paperSaved} sheets saved = ${treesContribution} trees + ${waterSavedLiters}L water + ${co2SavedGrams}g CO₂ prevented! You're saving the planet! 🌍`;
};
